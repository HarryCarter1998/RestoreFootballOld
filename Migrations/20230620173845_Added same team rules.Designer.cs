...
namespace RestoreFootball.Migrations
{
    ...
    [Migration("20230620173845_Added same team rules")]
    partial class Addedsameteamrules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestoreFootball.Models.SameTeamRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RestoreFootball.Models.GameweekPlayer", b =>
                {
                    ...
                    b.HasOne("RestoreFootball.Models.SameTeamRule", null)
                        .WithMany("GameweekPlayers")
                        .HasForeignKey("SameTeamRuleId");
